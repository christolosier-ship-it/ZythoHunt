...
export const STRUCTURAL_RECIPES={
 ...
 'fermentation-spontaneous':{vessel:'tulip',liquid:'fruit-pink',foam:'regular-white',primaryMotif:'barrel',secondaryMotif:'wild-bottle',composition:'left-right',accent:'wild-green',fillLevel:'high'},
 'fermentation-mixed-wild':{vessel:'tulip',liquid:'fruit-red',foam:'cream',primaryMotif:'yeast-cells',secondaryMotif:'wild-bottle',composition:'left-right',accent:'ruby',fillLevel:'high'},
 'family-pale-ale-ipa':{vessel:'pint',liquid:'deep-amber',foam:'generous-white',primaryMotif:'hop-cone',secondaryMotif:'citrus-slice',composition:'symmetric',accent:'hop-green',fillLevel:'high'},
