...
import {
  ...
  paleAlesBittersEtIpaCardImages
} from "./card-assets/pale-ales-bitters-et-ipa-assets.js";
...
const bundle = createCollectionBundle({
  ...
  assets: {
    collection: paleAlesBittersEtIpaAssets,
    cards: paleAlesBittersEtIpaCardImages
  },
  backgroundPreset: {
    beerT: 72,
    bubbleDensity: 58,
